...
def _apply_window_branding():
    ...
    main_window.setWindowTitle("SolidFreeCAD Desktop alpha.14 · Interactive Acceptance")
...
class SolidFreeCADWorkbench(Gui.Workbench):
    ...
    def Activated(self):
        from SolidFreeCAD.InteractiveAcceptanceWorkspaceCompat import show_workspace
    ...
    def Deactivated(self):
        from SolidFreeCAD.InteractiveAcceptanceWorkspaceCompat import hide_workspace
